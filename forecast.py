...
# Prominent features sequence= wind--> air temp--> pressure
plt.show()

# Scatter plot 
sns.pairplot(df, vars=['Air temperature | (°C)', 'Pressure | (atm)', 'Wind speed | (m/s)'])
plt.show()
...
df2 = pd.read_excel('our_forecast.xlsx')
...
df2.to_excel('our_forecast.xlsx', index=False)
